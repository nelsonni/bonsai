class Card {
  constructor(id, type) {
    ...
    $(close_button).attr({
      id: "close_button_" + id,
      class: "close"
    }).click(function() { // no arrow function here, binding required
...
//         $(lastFittingCard).addClass("lastFit");
...
//       .css({
//         width: parseInt(lastFittingCard.style.left) - parseInt(box[0].style.left) + 225
//       })
//       .addClass("expanded");
...
//       .addClass("expanded");
//     $(btn).css({
//       left: newWidth + (parseInt(box[0].style.left) - 15)
//     });
//   }
// }
//
...
//   $(btn).css({
//     left: parseInt(base[0].style.left) + (180 + ((base.children.length) * 10))
//   });
//   $(base[0].children).each(function(idx) {
//     if (this.classList.contains("actualCard")) {
//       $(this)
//         .removeClass("Wrapped lastFit")
//         .css({
//           zIndex: getHighestZIndexCard(),
...
//       console.log("id: " + id + ", type of Card: " + $("#" + id) instanceof Card);
